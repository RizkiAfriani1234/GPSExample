package id.ac.polbeng.rizkiafriani.gpsexample
...
import id.ac.polbeng.rizkiafriani.gpsexample.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        task.addOnSuccessListener {
            locationRequest = LocationRequest.create().apply {
                ...
                // application will never receive updates more
               // frequently than this value.
                fastestInterval = TimeUnit.SECONDS.toMillis(10)

                // Sets the maximum time when batched location updates
               // are delivered. Updates may be
            ...
            locationCallback = object : LocationCallback() {
                override fun onLocationResult(locationResult:
                    ...
                    if (locationResult.locations.isNotEmpty()) {
                        ...
                        // get latitude , longitude and other info
                        //from this
                        val latitude = location.latitude.toString()
                        val longitude = location.longitude.toString()
                        logResultsToScreen("$latitude, $longitude")
        ...
        fusedLocationClient.lastLocation
            .addOnSuccessListener { location : Location? ->
                // Got last known location. In some rare situations
               // this can be null.
